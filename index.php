...
<div class="container">
    <form class="FormReg col-3" method="post">
        <div class="ErrMessage"> <?php echo Calls::$ErrIfStingEmpty ?></div>
        <div class="form-group">
            <label for="Name">Имя</label>
            <input name="full_name" type="text" class="form-control" id="Name" placeholder="Введите имя">
        ...
        <div class="form-group">
            ...
            <input name="date_of_birth" type="date" class="form-control" id="DateOfBirth" placeholder="Выберите дату">
        </div>
        <div class="RegButtonAndLink">
            <button name="submit-reg-form" type="submit" class="btn btn-primary">Зарегистрироваться</button>
